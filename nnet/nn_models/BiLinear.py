...
class BiLSTMTagger(nn.Module):
    ...
    def __init__(self, hps, *_):
        ...
        self.Bilinear = nn.Bilinear(lstm_hidden_dim, lstm_hidden_dim, self.tagset_size)
    ...
    def forward(self, sentence, p_sentence,  pos_tags, lengths, target_idx_in, region_marks,
        ...
        hidden_states_word = self.dropout_1(F.relu(self.Non_Predicate_Proj(hidden_states_3))).view(-1, self.hidden_dim)
        ...
        tag_space = self.Bilinear(hidden_states_word, hidden_states_predicate)
