...
class BiLSTMTagger(nn.Module):
    ...
    def __init__(self, hps, *_):
        ...
        self.head_dropout_unlabeled_FB = nn.Dropout(p=0.3)
        self.dep_dropout_unlabeled_FB = nn.Dropout(p=0.3)
        ...
        self.head_dropout_unlabeled_BF_2 = nn.Dropout(p=0.3)
        self.dep_dropout_unlabeled_BF_2 = nn.Dropout(p=0.3)
