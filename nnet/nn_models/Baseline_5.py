...
class BiLSTMTagger(nn.Module):
    ...
    def __init__(self, hps, *_):
        ...
        self.role_map = nn.Linear(in_features=role_embedding_dim * 2, out_features=4 * lstm_hidden_dim)
    ...
    def forward(self, sentence, p_sentence,  pos_tags, lengths, target_idx_in, region_marks,
        ...
        hidden_states_word = hidden_states_3
        ...
        hidden_states_predicate = predicate_embeds
