...
class BiLSTMTagger(nn.Module):
    ...
    def __init__(self, hps, *_):
        ...
        self.W_R = nn.Linear(2*lstm_hidden_dim, self.dep_size)
    ...
    def forward(self, sentence, p_sentence,  pos_tags, lengths, target_idx_in, region_marks,
        ...
        tag_space = nn.Linear(torch.cat((hidden_states_word, hidden_states_predicate), 2)).view(self.batch_size* len(sentence[0]), -1)
