...
class BiLSTMTagger(nn.Module):
    ...
    def forward(self, sentence, p_sentence,  pos_tags, lengths, target_idx_in, region_marks,
        ...
        Predicate_identification = self.Idenficiation(F.relu(self.MLP_identification(hidden_states_0, hidden_states_1)))
        ...
        predicate_embeds = F.relu(self.Predicate_Proj(predicate_embeds))
