...
class BiLSTMTagger(nn.Module):
    ...
    def __init__(self, hps, *_):
        ...
        self.elmo_mlp_0 = nn.Sequential(nn.Linear(2 * lstm_hidden_dim, self.elmo_emb_size), nn.ReLU())
        self.elmo_mlp_1 = nn.Sequential(nn.Linear(2 * lstm_hidden_dim, self.elmo_emb_size), nn.ReLU())
    ...
    def forward(self, sentence, p_sentence, pos_tags, lengths, target_idx_in, region_marks,
        ...
        h_layer_0 = self.elmo_mlp_0(hidden_states_0)  # .detach()
        h_layer_1 = self.elmo_mlp_1(hidden_states_1)  # .detach()
