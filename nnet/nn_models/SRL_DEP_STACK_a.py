...
class BiLSTMTagger(nn.Module):
    ...
    def __init__(self, hps, *_):
        ...
        self.num_layers = 2
        self.BiLSTM_DEP = nn.LSTM(input_size=sent_embedding_dim_SRL, hidden_size=lstm_hidden_dim, batch_first=True,
                                  bidirectional=True, num_layers=self.num_layers)
    ...
    def forward(self, sentence, p_sentence,  pos_tags, lengths, target_idx_in, region_marks,
        ...
        hidden_states_3 = self.hidden_state_dropout(hidden_states)
        ...
        DEPloss = loss_function(tag_space_DEP, dep_tags.view(-1))

        return SRLloss, DEPloss, SRLloss, SRLprobs, wrong_l_nums, all_l_nums, wrong_l_nums, all_l_nums,  \
